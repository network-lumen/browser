<template>
  <div
    v-if="open"
    class="findbar flex-align-center border-radius-12px absolute gap-6px p-8px border-default bg-primary z-50 right-12px shadow-0-8-24-rgba-0-0-0-0-12 top-10px"
    role="dialog"
  ...
  >
    <input
      ref="inputEl"
      v-model="query"
      class="findbar-input outline-none color-text-primary border-radius-10px text-13px border-default bg-primary h-30px py-0px px-8px w-220px border-color-accent-primary-focus-visible shadow-0-0-0-3-ios-blue-a25-focus-visible"
      type="text"
