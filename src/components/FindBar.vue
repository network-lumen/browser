<template>
  ...
  >
    <input
      ref="inputEl"
      v-model="query"
      class="findbar-input outline-none color-text-primary border-radius-10px text-13px border-default bg-primary h-30px py-0px px-8px w-220px border-color-accent-primary-focus-visible shadow-0-0-0-3-primary-a25-focus-visible"
      type="text"
