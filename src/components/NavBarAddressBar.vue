<template>
  <div class="appregion-no-drag flex-align-center flex-1 relative min-w-0 navbar-address-bar">
    ...
    <UiButton
      ...
      icon-padding-class=""
      class="narrow-hide flex-inline-align-justify-center size-28px color-text-tertiary absolute top-half translate-y-center right-6px"
    ...
    >
      <button
        ...
        class="flex-align-center gap-10px p-8px border-radius-10px w-full border-none cursor-pointer text-left min-w-0 hover-bg-hover"
        :class="index === highlighted ? 'bg-primary-a10' : 'bg-transparent'"
