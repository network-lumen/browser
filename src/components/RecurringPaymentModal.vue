          ...
          <div class="recurpay-group mb-16px">
            ...
            <div class="recurpay-input-with-button flex gap-8px">
              <input
                ...
                type="text"
                placeholder="lumen1..."
                class="recurpay-input flex-1 bg-primary color-text-primary outline-none text-14px border-1 border-radius-8px transition-all-02 py-10px px-12px font-inherit focus-border-primary focus-ring-blue placeholder-tertiary"
              />
