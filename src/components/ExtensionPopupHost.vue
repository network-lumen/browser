<template>
  <div class="absolute inset-0 z-1400 bg-transparent" @click="requestClose()">
    <div class="extension-popup-shell absolute overflow-hidden border-radius-14px bg-dark-111 right-12px border-1-white-a08 shadow-0-24-60-rgba-0-0-0-0-35 w-min-420px-100vw-n24px" :style="popupShellStyle" @click.stop>
