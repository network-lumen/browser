...
import { importRequest, importRequestMode } from '../stores/profileImportStore';
...
// A page asking for the import dialog: same entry point as the menu item, with
// the tab the caller wanted rather than the default.
watch(importRequest, () => {
  onImportProfileClick();
  importMode.value = importRequestMode.value;
});
