...
/**
 * Single access point for `window.lumen` as exposed by `electron/preloads/preload.cjs`
 ...
 * `electron/preloads/webview-preload.cjs` injects into `<webview>` content — same
