...
if(!lumen_api) {
  throw new Error("FATAL000001");
}
if(!gateway_lumen_api) {
  throw new Error("FATAL000002");
}
if(!profiles_lumen_api) {
  throw new Error("FATAL000003");
}
...
/**
 * gateway_lumen_api?.onIngestProgress
 * gateway_lumen_api.renameCid
 */