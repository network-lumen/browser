    ...
    <main class="walletpage-main-content flex flex-column flex-1 margin-0 min-w-0 overflow-y-auto padding-200-250 bg-secondary border-radius-0">
      ...
      <header class="walletpage-content-header flex-align-center-justify-space-between margin-bottom-150">
        ...
        <div v-if="currentView !== 'dex'" class="walletpage-header-actions flex gap-75">
          <button class="walletpage-action-btn primary flex-inline-align-center gap-62 border-radius-10px fw-500 cursor-pointer fs-14px border-1-transparent transition-all-02 padding-62-125" @click="connectWallet" v-if="!isConnected">
            <Link :size="16" />
            <span>Connect Wallet</span>
          </button>
          <button class="walletpage-action-btn primary flex-inline-align-center gap-62 border-radius-10px fw-500 cursor-pointer fs-14px border-1-transparent transition-all-02 padding-62-125" @click="sendTransaction" v-else>
            <Send :size="16" />
            <span>Send</span>
          </button>
        </div>
            ...
            >
              ...
              <div class="walletpage-asset-side flex-align-end flex-column gap-75 flex-justify-space-between">
                ...
                <div class="walletpage-asset-actions flex-align-center flex-wrap-wrap gap-50">
                  ...
                  <button
                    class="walletpage-action-btn secondary walletpage-asset-send-btn flex-inline-align-center gap-62 border-radius-10px fw-500 cursor-pointer fs-14px border-1-transparent transition-all-02 inline-flex gap-35 padding-62-125"
                  ...
                  <button
                    class="walletpage-action-btn secondary walletpage-asset-transfer-btn flex-inline-align-center gap-62 border-radius-10px fw-500 cursor-pointer fs-14px border-1-transparent transition-all-02 inline-flex gap-35 padding-62-125"
      ...
      <div v-else-if="currentView === 'dex'" class="walletpage-content-section flex flex-column gap-150 w-full">
        ...
        <div class="dex-list flex flex-column gap-100">
          ...
          >
            <div class="walletpage-dex-top flex-justify-space-between gap-100 padding-100-125">
              ...
              >
                <div class="walletpage-dex-logo flex-align-justify-center color-primary txt-weight-medium border-radius-16px border-1 bg-secondary overflow-hidden flex-shrink-0 fs-15px w-52px h-52px" :class="{ 'dex-logo-dark': dex.logoTheme === 'dark' }">
                  <img
                    v-if="dex.logoUrl"
                    :src="dex.logoUrl"
                    :alt="`${dex.name} logo`"
              ...
              <div class="walletpage-dex-side flex-align-end flex-column flex-justify-space-between gap-75">
                <div class="walletpage-dex-actions flex-align-center-justify-end flex-wrap-wrap gap-50">
                  <button
                    type="button"
                    class="walletpage-action-btn secondary walletpage-dex-detail-toggle flex-inline-align-center gap-62 border-radius-10px fw-500 cursor-pointer fs-14px border-1-transparent transition-all-02 flex-justify-center padding-62-125"
                    @click="toggleDexExpanded(dex.key)"
                  >
                    <ChevronDown
                      :size="16"
                  ...
                  <button
                    type="button"
                    class="walletpage-action-btn primary walletpage-dex-open-btn flex-inline-align-center gap-62 border-radius-10px fw-500 cursor-pointer fs-14px border-1-transparent transition-all-02 flex-justify-center padding-62-125"
            ...
            <div v-if="isDexExpanded(dex.key)" class="walletpage-dex-details bg-secondary border-top-1-light">
              ...
              <div v-if="dex.quickLinks.length" class="walletpage-dex-links flex flex-wrap-wrap margin-top-87 gap-50">
                <button
                  ...
                  type="button"
                  class="walletpage-dex-link-chip flex-inline-align-center gap-35 border-radius-full color-text-secondary cursor-pointer border-1 bg-card fs-13px transition-all-02 padding-50-75 hover-border-accent hover-color-accent"
        ...
        <div v-else class="walletpage-activities-list flex flex-column border-radius-12px w-full border-1 overflow-hidden">
          ...
          <div
            ...
            :key="tx.id"
            class="walletpage-activity-row gap-100 grid padding-100-125 flex-inline-align-center transition-all-02 border-bottom-1-light hover-bg-hover"
          >
            <div class="col-type">
            ...
            <div class="col-hash flex-align-center gap-50">
              ...
              <button
                class="walletpage-action-icon walletpage-explorer-btn flex-align-justify-center color-text-secondary cursor-pointer border-radius-6px border-1 bg-card transition-all-02 flex-shrink-0 padding-25 hover-bg-hover hover-scale-105"
      ...
      <div v-if="showAssetTransferModal" class="walletpage-modal-overlay flex-align-justify-center padding-100 fixed inset-0 z-1000 backdrop-blur-4" @click="closeAssetTransferModal">
        <div class="walletpage-modal-content send-modal asset-transfer-modal w-full bg-primary border-radius-16px overflow-y-auto max-w-500px max-h-90vh" @click.stop>
          <div class="walletpage-modal-header flex-align-center-justify-space-between border-bottom-1">
            ...
            <button class="walletpage-modal-close flex-align-justify-center size-36px border-radius-10px color-text-secondary cursor-pointer border-1 bg-card transition-all-02 hover-bg-hover hover-border-color" @click="closeAssetTransferModal">
              <X :size="18" />
            </button>
          </div>
          <div class="walletpage-modal-body padding-150" v-if="assetTransferContext">
            ...
            <div class="walletpage-asset-modal-grid gap-100 grid">
              ...
              <div class="walletpage-form-group margin-bottom-125">
                ...
                <div class="walletpage-input-wrapper relative">
                  <select class="walletpage-form-input walletpage-form-select w-full border-radius-10px color-text-primary cursor-pointer padding-75-100 border-2 fs-15px bg-card transition-all-02 mono font-inherit" v-model="assetTransferForm.destinationKey">
                    <option
            ...
            <button
              class="walletpage-btn-modal-primary disabled-fade-50 flex-align-justify-center w-full border-radius-12px txt-weight-light gap-62 cursor-pointer border-none bg-gradient-primary color-white fs-16px transition-all-02 padding-75-125 hover-lift-1"
      ...
      <div v-if="showSendModal" class="walletpage-modal-overlay flex-align-justify-center padding-100 fixed inset-0 z-1000 backdrop-blur-4" @click="closeSendModal">
        <div class="walletpage-modal-content send-modal w-full bg-primary border-radius-16px overflow-y-auto max-w-500px max-h-90vh" @click.stop>
          <div class="walletpage-modal-header flex-align-center-justify-space-between border-bottom-1">
            ...
            <button class="walletpage-modal-close flex-align-justify-center size-36px border-radius-10px color-text-secondary cursor-pointer border-1 bg-card transition-all-02 hover-bg-hover hover-border-color" @click="closeSendModal">
              <X :size="18" />
            </button>
          </div>
          <div class="walletpage-modal-body padding-150">
            ...
            <div v-if="!sendAssetContext" class="walletpage-form-group margin-bottom-125">
              ...
              <div class="walletpage-input-wrapper relative">
                <select class="walletpage-form-input walletpage-form-select w-full border-radius-10px color-text-primary cursor-pointer padding-75-100 border-2 fs-15px bg-card transition-all-02 mono font-inherit" v-model="sendTargetMode">
            ...
            <div v-if="isIbcSend" class="walletpage-form-group margin-bottom-125">
              ...
              <div class="walletpage-input-wrapper relative">
                <select
                  class="walletpage-form-input walletpage-form-select w-full border-radius-10px color-text-primary cursor-pointer padding-75-100 border-2 fs-15px bg-card transition-all-02 mono font-inherit"
      ...
      <div v-if="showReceiveModal" class="walletpage-modal-overlay flex-align-justify-center padding-100 fixed inset-0 z-1000 backdrop-blur-4" @click="closeReceiveModal">
        <div class="walletpage-modal-content receive-modal w-full bg-primary border-radius-16px overflow-y-auto max-w-500px max-h-90vh" @click.stop>
          <div class="walletpage-modal-header flex-align-center-justify-space-between border-bottom-1">
            ...
            <button class="walletpage-modal-close flex-align-justify-center size-36px border-radius-10px color-text-secondary cursor-pointer border-1 bg-card transition-all-02 hover-bg-hover hover-border-color" @click="closeReceiveModal">
              <X :size="18" />
            </button>
          </div>
          <div class="walletpage-modal-body padding-150">
            ...
            <div class="walletpage-address-box border-radius-12px padding-125 border-2 bg-secondary">
              ...
              <button class="walletpage-btn-copy-address disabled-fade-50 flex-align-justify-center w-full border-radius-10px txt-weight-light color-primary gap-50 cursor-pointer bg-card padding-75 fs-15px transition-all-02 hover-bg-hover" type="button" @click="copyAddressWithToast" :disabled="!address">
                <Copy :size="16" />
      ...
      <div v-if="showContactModal" class="walletpage-modal-overlay flex-align-justify-center padding-100 fixed inset-0 z-1000 backdrop-blur-4" @click="closeContactModal">
        <div class="walletpage-modal-content walletpage-contact-modal w-full bg-primary border-radius-16px overflow-y-auto max-w-500px max-h-90vh" @click.stop>
          <div class="walletpage-modal-header flex-align-center-justify-space-between border-bottom-1">
            ...
            <button class="walletpage-modal-close flex-align-justify-center size-36px border-radius-10px color-text-secondary cursor-pointer border-1 bg-card transition-all-02 hover-bg-hover hover-border-color" @click="closeContactModal">
              <X :size="18" />
            </button>
          </div>
          <div class="walletpage-modal-body padding-150">
      ...
      <div v-if="showDeleteConfirmModal" class="walletpage-modal-overlay flex-align-justify-center padding-100 fixed inset-0 z-1000 backdrop-blur-4" @click="cancelDeleteContact">
        <div class="walletpage-modal-content walletpage-delete-confirm-modal w-full bg-primary border-radius-16px overflow-y-auto max-w-500px max-h-90vh max-w-420px" @click.stop>
          <div class="walletpage-modal-header flex-align-center-justify-space-between border-bottom-1">
            ...
            <button class="walletpage-modal-close flex-align-justify-center size-36px border-radius-10px color-text-secondary cursor-pointer border-1 bg-card transition-all-02 hover-bg-hover hover-border-color" @click="cancelDeleteContact">
              <X :size="18" />
            </button>
          </div>
          <div class="walletpage-modal-body padding-150">
