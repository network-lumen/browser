<template>
  <div class="extension-page absolute inset-0 flex min-h-0 min-w-0 bg-dark-111">
    ...
    <div
      ...
      class="extension-status w-full fs-14px text-center flex-align-justify-center padding-150 color-white-a82"
    >
    ...
    <div v-else-if="loading && !webviewMountUrl" class="extension-status w-full fs-14px text-center flex-align-justify-center padding-150 color-white-a82">
      Loading extension…
    </div>
    <webview
    ...
    ></webview>
    <div v-else class="extension-status w-full fs-14px text-center flex-align-justify-center padding-150 color-white-a82">
      Preparing extension…
    </div>
  </div>
</template>
