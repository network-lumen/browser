              ...
              <div class="netpage-block-right flex-align-center flex-0-0-auto gap-16px">
                <div class="netpage-block-meta flex flex-column flex-align-end gap-6px flex-justify-center">
                  <div class="meta-item flex-align-center gap-8px">
                    ...
                    <span class="netpage-meta-value flex-inline-align-justify-center color-text-secondary txt-weight-medium bg-tertiary border-1 border-radius-4px text-13px py-0px px-8px h-22px min-w-32px" :class="{ 'bg-fill-success border-color-ios-green-a30 color-ios-green': block.txs > 0 }">{{ block.txs }}</span>
                  </div>
