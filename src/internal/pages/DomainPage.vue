      ...
      <header class="domainpage-content-header flex-align-center flex-justify-space-between margin-bottom-150">
        ...
        <div class="domainpage-header-actions flex gap-75">
          <template v-if="activeNameTab === 'lumen'">
            <button class="domainpage-btn primary flex-inline-align-center gap-50 border-radius-10px fs-085rem fw-500 txt-weight-light txt-sm cursor-pointer outline-none border-1-transparent padding-62-100" type="button" @click="openRegisterModal">
              <Plus :size="16" />
              <span>Buy domain</span>
            </button>
          </template>
          <template v-else>
            <button class="domainpage-btn secondary flex-inline-align-center gap-50 border-radius-10px fs-085rem fw-500 txt-weight-light txt-sm cursor-pointer outline-none border-1-transparent padding-62-100" type="button" @click="importStableLink">
              <Upload :size="16" />
              <span>Import</span>
            </button>
            <button class="domainpage-btn primary flex-inline-align-center gap-50 border-radius-10px fs-085rem fw-500 txt-weight-light txt-sm cursor-pointer outline-none border-1-transparent padding-62-100" type="button" @click="createStableLink">
              <Plus :size="16" />
              <span>Generate</span>
            </button>
          </template>
