<template>
  <div class="w-full h-full min-h-0 bg-tertiary overflow-hidden" :class="{ 'webpage-fullscreen': webviewHtmlFullscreen }">
    <div v-if="isChromeWebStorePage" class="w-full h-full flex-align-justify-center padding-200 bg-primary">
      <div class="webpage-store-proxy-card flex flex-column gap-87 text-center padding-150 border-radius-20px">
        ...
        <button type="button" class="webpage-store-proxy-btn border-none color-white cursor-pointer border-radius-full txt-weight-light" @click="openChromeWebStoreImport">
          Open Extensions
        </button>
      </div>
    </div>
