        ...
        <div class="flex flex-column gap-20px">
          ...
          <div v-else class="flex flex-column gap-8px">
            ...
            <div class="grid-cols-4-1fr gap-8px grid">
              ...
              <UiButton variant="secondary" @click="$emit('set-percentage', 100)" class="hover-bg-primary-a10">Max</UiButton>
            </div>
          </div>
            ...
            <div class="flex-align-center flex-column gap-24px text-center">
              ...
              <UiResultState v-else-if="txStatus === 'success'" title="Transaction Successful!" :description="txMessage">
                ...
                <template #action>
                  ...
                  <button class="mt-16px txt-weight-light cursor-pointer bg-accent color-white border-none border-radius-6px text-14px transition-all-02 hover-lift-1 py-10px px-32px hover-shadow-primary" @click="$emit('update:modelValue', false)">Close</button>
                </template>
              </UiResultState>
              ...
              <UiResultState v-else-if="txStatus === 'error'" title="Transaction Failed" :description="txMessage">
                ...
                <template #action>
                  <UiButton variant="primary" class="mt-8px" @click="$emit('reset')">Try Again</UiButton>
                </template>
              </UiResultState>
            </div>
          </div>
