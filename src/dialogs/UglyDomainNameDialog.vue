<template>
  <UiModal :model-value="modelValue" :title="mode === 'import' ? 'Import ugly domain' : 'Generate ugly domain'" panel-class="max-w-500px" @update:model-value="$emit('update:modelValue', false)">
